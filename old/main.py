# AGNC Technical Analysis - Main Execution Script
...
def main():
    ...
    try:
        ...
        from forecasting import (generate_return_forecasts, create_ensemble_forecast, 
                               run_monte_carlo_simulation, calculate_risk_metrics)
        ...
        from pdf_generation import setup_pdf_generation
        doc, pdf_content, add_to_pdf, pdf_filename = setup_pdf_generation()
        print("✅ PDF generation setup completed")
        print()
        
        # Step 8: Plotting
        print("Step 8: Generating plots...")
        from plotting import (plot_technical_indicators, plot_forecasts, plot_advanced_analysis)
        
        plot_technical_indicators(df, fibs, pdf_content, add_to_pdf)
        plot_forecasts(r, ar_res, arma_res, arima_res, arima_order, return_forecasts, 
                      ensemble_fc, pdf_content, add_to_pdf)
        plot_advanced_analysis(df, mc_paths, mc_percentiles, percentiles, garch_fit, 
        ...
        generate_pdf_report(doc, pdf_content, add_to_pdf, pdf_filename, df, fibs, 
